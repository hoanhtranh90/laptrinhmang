...
import { CreateProductDTO } from "../../../redux/api/apiTypes";
import { useAddProductMutation } from "../../../redux/api/MarketApi";
...
const CreatePost1 = ({ visible, toggleModal, onSuccess }: Props) => {
    ...
    const onFinish = (values: any) => {
        ...
        addPost(postInfo).unwrap().then(res => {
            ...
            toggleModal();
            setLoading(false);
            addImageAfterSubmit(res.productId, imageIds);
        }).catch(err => {
            notification.error({
